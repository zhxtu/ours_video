...
def HRNetBackbone(self, arch='hrnet48', resume=None):
    # def __init__(self, arch='hrnet48', resume=None):
    # self.arch = arch
    # self.resume = resume
...
#     arch = self.arch
#     resume = self.resume
    from models.modeling.backbone.hrnet_config import MODEL_CONFIGS
