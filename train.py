...
def main(gpu, ngpus_per_node, config, resume, test):
    ...
    iter_per_epoch = 86
    # iter_per_epoch = config['n_labeled_examples'] * config['n_unlabeled_ratio'] // config['train_unsupervised']['batch_size']
    ...
    config['test_loader'] = config['val_loader']
...
if __name__=='__main__':
    ...
    parser.add_argument('-c', '--config', default='configs/thermalseq_cac_deeplabv3+_resnet50_1over8_supervised.json',type=str,
