...
class BaseDataSet(Dataset):
    def __init__(self, data_dir, split, mean, std, ignore_index, base_size=None, augment=True, val=False,
                ...
                blur=False, return_id=False, n_labeled_examples=None, n_unlabeled_ratio=None):
        ...
        self.n_unlabeled_ratio = n_unlabeled_ratio
        self.val = val
        ...
        self.jitter_tf = transforms.ColorJitter(brightness=0.4, contrast=0.4, saturation=0.4, hue=0.1)
    ...
    def __getitem__(self, index):
        ...
        if self.val:
            ...
            image, label = self._augmentation(image, label) #memory up
