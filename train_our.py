...
from trainer_our import TrainerOur
...
def main(gpu, ngpus_per_node, config, resume, test):
    ...
    # iter_per_epoch = 86
    iter_per_epoch = config['n_labeled_examples'] // config['train_unsupervised']['batch_size']
...
if __name__=='__main__':
    ...
    parser.add_argument('-c', '--config', default='configs/thermalour_cac_deeplabv3+_resnet101_1over8_datalist0.json',type=str,
