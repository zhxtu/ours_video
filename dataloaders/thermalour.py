...
class PairThermalOurDataset(BaseDataSet):
    def __init__(self, **kwargs):
        ...
        super(PairThermalOurDataset, self).__init__(**kwargs)
...
class PairThermalOur(BaseDataLoader):
    def __init__(self, kwargs):
        ...
        self.dataset = PairThermalOurDataset(**kwargs)
        shuffle = False
        dist_sampler = torch.utils.data.distributed.DistributedSampler(self.dataset, shuffle=sampler_shuffle)

        super(PairThermalOur, self).__init__(self.dataset, self.batch_size, shuffle, num_workers, val_split=None, dist_sampler=dist_sampler)


class ThermalOurDataset(BaseDataSet):
    def __init__(self, **kwargs):
        self.num_classes = 17
        ...
        self.ignore_index = 255
        self.class_map = dict(zip(self.valid_classes, range(17)))
        super(ThermalOurDataset, self).__init__(**kwargs)
...
class ThermalOur(BaseDataLoader):
    def __init__(self, kwargs):
        ...
        self.dataset = ThermalOurDataset(**kwargs)
        shuffle = False
        dist_sampler = torch.utils.data.distributed.DistributedSampler(self.dataset, shuffle=sampler_shuffle)

        super(ThermalOur, self).__init__(self.dataset, self.batch_size, shuffle, num_workers, val_split=None, dist_sampler=dist_sampler)
